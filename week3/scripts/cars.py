...
def process_data(data):
  ...
  max_year = {"total_sales": 0}
  for yr in year_sales:
    if year_sales[yr] > max_year["total_sales"]:
      max_year = {"year": yr, "total_sales": year_sales[yr]}
...
def main(argv):
  ...
  print(summary_text)
  reports.generate("/tmp/cars.pdf", "Sales summary for last month", summary_text, table)
